...
- **Affected File/API**: `src/fl_studio_mcp/tools/internal_eq.py`, native mixer EQ commands
...
- **Reproduction Steps**: Inspect `src/fl_studio_mcp/tools/internal_eq.py` and run `.venv/bin/python scripts/check_tool_registration_baseline.py`.
