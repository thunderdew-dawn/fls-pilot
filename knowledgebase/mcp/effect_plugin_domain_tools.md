...
- **Context**: v1.2 slice 09 adds additive domain tools beside legacy effect/plugin tools for parity testing and lower tool-selection overhead.
...
- **Next Recommended Action**: Implement slice 10, the additive Piano Roll domain tool, with extra attention to the existing undo-backed safety model and readback limits.
